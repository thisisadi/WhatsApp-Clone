...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imgGoogleLogin.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.btLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (binding.etEmailLogin.getText().toString().isEmpty() || binding.etPasswordLogin.getText().toString().isEmpty())
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (metadata.getCreationTimestamp() == metadata.getLastSignInTimestamp()) {
                                // The user has signed in for the first time using Google Auth.
